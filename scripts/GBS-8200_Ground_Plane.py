"""Render the GBS-8200 ground plane from YAML."""
...
DEFAULT_SPEC = Path("projets/GBS-8200/GBS-8200_Ground_Plane.yml")


def parse_args() -> argparse.Namespace:
    """Parse CLI arguments."""

    parser = argparse.ArgumentParser(description="Render the GBS-8200 ground plane DXF.")
    parser.add_argument(
        "--spec",
        type=Path,
