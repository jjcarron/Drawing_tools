"""Render the GBS-8200 front panel from YAML."""
...
DEFAULT_SPEC = Path("projets/GBS-8200/GBS-8200_Front_Panel.yml")


def parse_args() -> argparse.Namespace:
    """Parse CLI arguments."""

    parser = argparse.ArgumentParser(description="Render the GBS-8200 front panel DXF.")
    parser.add_argument(
        "--spec",
        type=Path,
